...
*/
        ...
        _mceImage : function(ui, val) {
            ...
            ed.windowManager.open({
                url : tinymce.baseURL + '/themes/advanced/image.html',
                width : 280, // + parseInt(ed.getLang('advanced.image_delta_width', 0)),
                height : 500, //+ parseInt(ed.getLang('advanced.image_delta_height', 0)),
                inline : false,
                scrollbars : false
            }, {
                theme_url : this.url
        ...
        _mceLink : function(ui, val) {
            ...
            ed.windowManager.open({
                url : tinymce.baseURL + '/themes/advanced/link.html',
