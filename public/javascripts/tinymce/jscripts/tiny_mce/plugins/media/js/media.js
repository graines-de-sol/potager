...
function insertMedia() {
	...
	if (fe != null && /mceItem(Flash|ShockWave|WindowsMedia|QuickTime|RealMedia)/.test(ed.dom.getAttrib(fe, 'class'))) {
		...
		//Beuaaark, REALLY quick and dirty hack ever ! 2009/08/12 GB
		title_array = serializeParameters().split("'"),
    h = '<div class="video_container"><object codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab" width="400" height="300" id="FLVPlayer">';
    h += '<param name="movie" value="/flash/FLVPlayer_Progressive.swf" />';
    h += '<param name="salign" value="lt" />';
    h += '<param name="quality" value="high" />';
    h += '<param name="scale" value="noscale" />';
    h += '<param name="wmode" value="transparent" />';
    h += '<embed src="/flash/FLVPlayer_Progressive.swf" flashvars="&skinName=/flash/clearSkin_3&streamName='+title_array[1]+'&autoPlay=false&autoRewind=false" quality="high" scale="noscale" width="300" height="220" name="FLVPlayer" salign="LT" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" wmode="transparent" />';
    h += '</object></div>';	
